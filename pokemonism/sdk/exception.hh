...
#include <pokemonism/sdk/cloneable.hh>
...
#define pokemon_exception_check(condition, level, code) do {                                                                        \
    if(condition) {                                                                                                                 \
        ...
        pokemonLog("[%s:%d/%s] %s(...) => %s\n", __FILE__, __LINE__, pokemonism::sdk::exception::to(level), __func__, #condition);  \
        code;                                                                                                                       \
    }                                                                                                                               \
} while (0)
...
#define pokemon_critical_throw(condition, code)             pokemon_exception_throw("critical", pokemonism::sdk::exception::level::critical, code)
#define pokemon_warning_throw(condition, code)              pokemon_exception_throw("warning", pokemonism::sdk::exception::level::warning, code)
#define pokemon_caution_throw(condition, code)              pokemon_exception_throw("caution", pokemonism::sdk::exception::level::caution, code)
#define pokemon_notice_throw(condition, code)               pokemon_exception_throw("notice", pokemonism::sdk::exception::level::notice, code)
#define pokemon_information_throw(condition, code)          pokemon_exception_throw("information", pokemonism::sdk::exception::level::information, code)
#define pokemon_debug_throw(condition, code)                pokemon_exception_throw("debug", pokemonism::sdk::exception::level::debug, code)
#define pokemon_verbose_throw(condition, code)              pokemon_exception_throw("verbose", pokemonism::sdk::exception::level::verbose, code)
#define pokemon_develop_throw(condition, code)              pokemon_exception_throw("develop", pokemonism::sdk::exception::level::develop, code)

#define pokemon_critical_quick_throw(condition)             pokemon_exception_throw("critical", pokemonism::sdk::exception::level::critical, (void)(0))
#define pokemon_warning_quick_throw(condition)              pokemon_exception_throw("warning", pokemonism::sdk::exception::level::warning, (void)(0))
#define pokemon_caution_quick_throw(condition)              pokemon_exception_throw("caution", pokemonism::sdk::exception::level::caution, (void)(0))
#define pokemon_notice_quick_throw(condition)               pokemon_exception_throw("notice", pokemonism::sdk::exception::level::notice, (void)(0))
#define pokemon_information_quick_throw(condition)          pokemon_exception_throw("information", pokemonism::sdk::exception::level::information, (void)(0))
#define pokemon_debug_quick_throw(condition)                pokemon_exception_throw("debug", pokemonism::sdk::exception::level::debug, (void)(0))
#define pokemon_verbose_quick_throw(condition)              pokemon_exception_throw("verbose", pokemonism::sdk::exception::level::verbose, (void)(0))
#define pokemon_develop_quick_throw(condition)              pokemon_exception_throw("develop", pokemonism::sdk::exception::level::develop, (void)(0))
