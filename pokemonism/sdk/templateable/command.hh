...
namespace pokemonism::sdk::templateable {
    ...
    public:     template <class commandable = pokemonism::sdk::command, typename outputable = commandable::output> inline command::subscription<commandable, outputable> * genericReg(command::subscription<commandable, outputable> * subscription);
    public:     template <class commandable = pokemonism::sdk::command, typename outputable = commandable::output> inline command::subscription<commandable, outputable> * genericReg(commandable * object, unsigned int properties, const command::event::callback<commandable, outputable>::set & eventSet);
    public:     template <class commandable = pokemonism::sdk::command, typename outputable = commandable::output> inline command::subscription<commandable, outputable> * genericReg(commandable * object, unsigned int properties, const command::event::callback<commandable, outputable>::set & eventSet, command::subscription<commandable, outputable>::state::callback::function subscriptionOn);
    public:     template <class commandable = pokemonism::sdk::command, typename outputable = commandable::output> inline command::subscription<commandable, outputable> * genericReg(commandable * object, unsigned int properties, const command::event::callback<commandable, outputable>::set & eventSet, command::subscription<commandable, outputable>::state::callback::modifier subscriptionReleaseOn);
    public:     template <class commandable = pokemonism::sdk::command, typename outputable = commandable::output> inline command::subscription<commandable, outputable> * genericReg(commandable * object, unsigned int properties, const command::event::callback<commandable, outputable>::set & eventSet, command::subscription<commandable, outputable>::state::callback::function subscriptionOn, command::subscription<commandable, outputable>::state::callback::modifier subscriptionReleaseOn);
