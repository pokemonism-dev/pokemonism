...
#ifndef   __POKEMONISM_POKEMON_PRIMITIVABLE__HH__
#define   __POKEMONISM_POKEMON_PRIMITIVABLE__HH__
...
namespace pokemon {
    ...
    public:     struct object {
                public:     class to {
                            public:     inline static int8      int8(const object * o) { return static_cast<pokemon::int8>(reinterpret_cast<pokemon::uint64>(o)); }
                            public:     inline static int16    int16(const object * o) { return static_cast<pokemon::int16>(reinterpret_cast<pokemon::uint64>(o)); }
                            public:     inline static int32    int32(const object * o) { return static_cast<pokemon::int32>(reinterpret_cast<pokemon::uint64>(o)); }
                            public:     inline static int64    int64(const object * o) { return static_cast<pokemon::int64>(reinterpret_cast<pokemon::uint64>(o)); }
                            public:     inline static uint8    uint8(const object * o) { return static_cast<pokemon::uint8>(reinterpret_cast<pokemon::uint64>(o)); }
                            public:     inline static uint16  uint16(const object * o) { return static_cast<pokemon::uint16>(reinterpret_cast<pokemon::uint64>(o)); }
                            public:     inline static uint32  uint32(const object * o) { return static_cast<pokemon::uint32>(reinterpret_cast<pokemon::uint64>(o)); }
                            public:     inline static uint64  uint64(const object * o) { return reinterpret_cast<pokemon::uint64>(o); }
...
#endif // __POKEMONISM_POKEMON_PRIMITIVABLE__HH__