/**
 * @file        pokemonism/pokemon/interface/synchronizable.hh
 * @brief
 * @details
 *
...
#ifndef   __POKEMONISM_POKEMON_INTERFACE_SYNCHRONIZABLE__HH__
#define   __POKEMONISM_POKEMON_INTERFACE_SYNCHRONIZABLE__HH__
...
namespace pokemonism {
    ...
    using synchronizable = pokemon::synchronizable;
}

#endif // __POKEMONISM_POKEMON_INTERFACE_SYNCHRONIZABLE__HH__