...
#ifndef   __POKEMONISM_CONSOLE_APPLICATIONABLE_HH__
#define   __POKEMONISM_CONSOLE_APPLICATIONABLE_HH__

#include <pokemonism/applicationable.hh>

namespace pokemonism::console {
...
#endif // __POKEMONISM_CONSOLE_APPLICATIONABLE_HH__