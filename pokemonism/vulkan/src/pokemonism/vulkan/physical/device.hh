...
namespace pokemonism::vulkan::physical {
    ...
    public:     inline device(const vulkan::physical::device & o) : handle(nullptr) { pokemon_develop_throw((void)(0)); }
    public:     inline device(vulkan::physical::device && o) noexcept : handle(o.handle) { o.handle = nullptr; }
    public:     inline vulkan::physical::device & operator=(const vulkan::physical::device & o) { pokemon_develop_throw(return *this); }
    public:     inline vulkan::physical::device & operator=(vulkan::physical::device && o) noexcept { pokemon_develop_exit_check(true, return *this); }
    };
