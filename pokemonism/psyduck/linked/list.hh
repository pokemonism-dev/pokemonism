...
#ifndef   __POKEMONISM_PSYDUCK_LINKED_LIST__HH__
#define   __POKEMONISM_PSYDUCK_LINKED_LIST__HH__
...
namespace pokemonism {
    ...
    namespace linked {
        template <class container, class element> using list = pokemonism::psyduck::linked::list<container, element>;
    }
}

#endif // __POKEMONISM_PSYDUCK_LINKED_LIST__HH__