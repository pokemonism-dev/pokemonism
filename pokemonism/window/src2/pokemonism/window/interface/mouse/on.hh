...
#ifndef   __POKEMONISM_WINDOW_INTERFACE_MOUSE_ON_HH__
#define   __POKEMONISM_WINDOW_INTERFACE_MOUSE_ON_HH__

#include <pokemonism/observerable.hh>
#include <pokemonism/sdk/linked/list.hh>
#include <pokemonism/window/src/pokemonism/window.old/interface/mouse/pos.hh>
...
#endif // __POKEMONISM_WINDOW_INTERFACE_MOUSE_ON_HH__