...
#ifndef   __POKEMONISM_WINDOW_INTERFACE_KEYBOARD_HH__
#define   __POKEMONISM_WINDOW_INTERFACE_KEYBOARD_HH__

#include <pokemonism/observable.hh>
#include <pokemonism/sdk/linked/list.hh>
#include <pokemonism/window/src/pokemonism/window.old/interface/keyboard/key.hh>
...
#endif // __POKEMONISM_WINDOW_INTERFACE_KEYBOARD_HH__