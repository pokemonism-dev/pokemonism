// /**
//  * @file        pokemonism/latios/internal/command/generator.cc
//  * @brief
//  * @details
//  *
...
//             namespace command {
//
//                 generator::generator(general::engine *engine) : internal::generator<pokemonism::command>(nullptr) {
//
//                 }
//
//
...
//                 // public:     typedef event::subscription                                 node;
