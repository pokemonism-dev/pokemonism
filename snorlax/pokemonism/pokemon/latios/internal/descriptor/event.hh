...
#include <pokemon/latios/external/descriptor/event.hh>
...
namespace pokemon { namespace latios { namespace internal { namespace descriptor {
    ...
    class event : public internal::event, public external::descriptor::event {
    public:     inline descriptor::subscription * subscriptionGet(void) const { return dynamic_cast<descriptor::subscription *>(node->subscriptionGet()); }
        /** OVERRIDE INTERNAL::EVENT */
    protected:  int on(pokemon::exception * e) override;
        /** CUSTOM CONSTRUCTOR */
